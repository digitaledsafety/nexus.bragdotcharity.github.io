...
contract ExhibitVault is ERC721Holder, ERC1155Holder, ReentrancyGuard {
    ...
    /**
     * @dev Withdraw multiple ERC1155 tokens from the same contract back to the owner's wallet using safeBatchTransferFrom.
     */
    ...
    /**
     * @dev Move multiple ERC1155 tokens from the same contract directly to another verified vault using safeBatchTransferFrom.
     */
