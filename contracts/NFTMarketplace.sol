...
contract NFTMarketplace is ReentrancyGuard, Ownable {
    ...
    event OfferAccepted(address indexed nftContract, uint256 indexed tokenId, address indexed buyer, uint256 price, uint256 amount, address seller);
    ...
    function acceptOffer(address nftContract, uint256 tokenId, address buyer) external nonReentrant {
        ...
        emit OfferAccepted(nftContract, tokenId, buyer, offer.price, offer.amount, msg.sender);
    }
